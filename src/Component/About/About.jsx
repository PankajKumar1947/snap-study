...
const About = () => {
  return (
    <div className='flex flex-col gap-5 items-center justify-center text-white bg-gray-900 pt-4'>
        ...
        <p className='font-thin text-xl w-[60%] text-center'>​This is the space to introduce the business and what it has to offer. Define the qualities and values that make it unique. </p>
        <NavLink to={"/about"}>
        ...
        <div className='flex gap-10 my-8'>
            <div className='w-[220px] rounded-md overflow-hidden -mt-8'>
                <img src={image1} alt="" />
            </div>
