...
const ProductCard = ({elem}) => {
  return (
    <div className='h-[200px] border-[1px] rounded-lg p-5 bg-gradient-to-r from-gray-600 to-gray-800 cursor-pointer hover:bg-gray-900 duration-300 group relative'>
