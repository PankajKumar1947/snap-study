    ...
    <div>
      <div className={`oveflow-hidden relative group cursor-pointer hover:opacity-80 `}>
        ...
        <div className='absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] '>
          <button className='bg-white text-black px-3 py-2 rounded-full group-hover:bg-black group-hover:text-white duration-200'>{selectedBranch==elem.name ? "selected" : "select"}
          </button>
        </div>
      </div>
