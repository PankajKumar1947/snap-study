...
const DonateDetails = () => {
  ...
  return (
    <div className='text-white max-w-[95%] sm:max-w-[70%] mx-auto'>
      
      <div className='m-2'>
        <h1 className='text-cyan-500 font-semibold text-2xl sm:text-3xl'>Contributing a YouTube Lectures ?</h1>
      ...
      <div className='m-2'>
        <h1 className='text-cyan-500 font-semibold text-2xl sm:text-3xl'>Contributing a pdf of Organiser/Pyq ? </h1>
        <h2 className='font-semibold italic text-indigo-500'>Guidlines</h2>
        <ul className='list-decimal px-4'>
      ...
      <div className='m-2'>
        <h1 className='text-cyan-500 font-semibold text-2xl sm:text-3xl'>Found a Bug in Website ? </h1>
        <h2 className=' italic text-red-500 underline'>
