...
const Newsletter = () => {
  ...
  return (
    <div className='sm:max-w-[70%] mx-2 sm:mx-auto rounded-2xl my-14 bg-gray-600 text-white p-5'>
        <h1 className='text-3xl sm:text-4xl'>Subscribe to our newsletter</h1>
